...
import com.ram.speed.booster.utils.RamUtils;
...
public class MemoryScanner implements Runnable, Constants {
    ...
    public void run() {
        ...
        long availableRam = RamUtils.calculateAvailableRAM(context) / weight;
        long totalRam = RamUtils.calculateTotalRAM() / weight;
